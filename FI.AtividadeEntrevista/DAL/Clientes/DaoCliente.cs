        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (cliente.Beneficiarios != null)
                {
                    ...
                    {
                        List<System.Data.SqlClient.SqlParameter> parBenef = new List<System.Data.SqlClient.SqlParameter>();
                        parBenef.Add(new System.Data.SqlClient.SqlParameter("CPF", benef.CPF));
                        parBenef.Add(new System.Data.SqlClient.SqlParameter("NOME", benef.Nome));
                        parBenef.Add(new System.Data.SqlClient.SqlParameter("IDCLIENTE", ret));

                        dsBenef = base.Consultar("FI_SP_IncBeneficiario", parBenef);
                    } 
                }
            }
